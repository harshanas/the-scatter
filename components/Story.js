...
export default function Story() {
  return (
    <react.Fragment>
        <h1 class={styles['story-title']}>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit
        </h1>
        <h6 class="text-muted">Posted on 22nd May 2022 at 17:45:00 </h6>
        <Image src={storyImg} class="img-fluid rounded-start" />
        <p class="mt-3"> Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati, assumenda reprehenderit cupiditate quod distinctio natus modi temporibus deleniti debitis consequatur excepturi cumque, tempore placeat magnam doloribus totam exercitationem consequuntur aut.</p>
